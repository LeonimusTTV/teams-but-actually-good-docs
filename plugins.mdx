...
<AccordionGroup>
  ...
  <Accordion title="enableByDefault (optional)">
    Used to enable plugins by default, official, non essential plugin won't have this enable. You can always use this for your custom plugins.
  </Accordion>
...
<Warning>
  To find the right `find` and `match` values, you need to inspect Teams' minified bundle using React DevTools and your browser's dev tools. This is an advanced topic, we recommend looking for existing tutorials on patching webpack modules.
</Warning>
